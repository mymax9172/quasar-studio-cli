...
export const update = (context) => {
	context.program
		.command("update")
		.description("update Quasar studio or Quasar Studio CLI git repository")
		.option("--cli", "update only the Quasar Studio CLI")
		.option("--app", "update only the Quasar Studio Application")
